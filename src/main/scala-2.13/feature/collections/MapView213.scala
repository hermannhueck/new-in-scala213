...
object MapView213 extends App {
  ...
  "\n>>> Map#mapValues returns MapView instead of Map and is deprecated in 2.13:" pipe println
  ...
  "\n>>> Map#filterKeys returns MapView instead of Map and is deprecated in 2.13:" pipe println
